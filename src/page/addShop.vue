    ...
    <div>
        ...
        <el-row style="margin-top: 20px;">
            <el-col :span="12" :offset="4">
                <el-form :model="ruleForm" :rules="rules" label-width="11px;" class="demo-ruleForm">
                    ...
                    <el-form-item label="配送费" prop="float_delivery_fee">
                        <el-input v-model="ruleForm.float_delivery_fee"></el-input>
                    </el-form-item>
                    <el-form-item label="起送价" prop="float_minmum_order_amout">
                        <el-input-number v-model="ruleForm.float_minmum_order_amout" :min="0" :max="100"></el-input-number>
                    </el-form-item>
                    ...
                    <el-form-item label="上传店铺头像">
                        <el-upload
                            ...
                            <img :src="ruleForm.image_path" class="avatar" v-if="ruleForm.image_path">
                    ...
                    <el-form-item label="上传营业执照">
                        <el-upload
                            class="avatar-uploader"
                            action="//jsonpllaceholder.typicode.com/posts"
                            :show-file-list="false"
